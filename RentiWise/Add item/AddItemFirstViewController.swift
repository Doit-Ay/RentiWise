...
class AddItemFirstViewController: UIViewController,
    ...
    @IBAction func continueTapped(_ sender: UIButton) {
        ...
        DispatchQueue.main.async {
            if let presented = self.presentedViewController {
                print("Dismissing presented VC before navigation:", presented)
    ...
    private func presentDetail(_ vc: UIViewController) {
        if let nav = self.navigationController {
            print("Pushing on existing navigation stack")
            nav.pushViewController(vc, animated: true)
        } else {
            print("Presenting inside a new navigation controller")
